<?php
/**
 * revenue_pro functions and definitions.
 *
...
if ( ! function_exists( 'revenue_pro_setup' ) ) :

function revenue_pro_setup() {

	load_theme_textdomain( 'revenue-pro', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'revenue-pro' ),
		'footer' => esc_html__( 'Footer Menu', 'revenue-pro' ),		
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'revenue_pro_custom_background_args', array(
 ...
 */
function revenue_pro_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'revenue_pro_content_width', 760 );
}
add_action( 'after_setup_theme', 'revenue_pro_content_width', 0 );
 ...
 */
function revenue_pro_sidebar_init() {

	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'revenue-pro' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'revenue-pro' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 1', 'revenue-pro' ),
		'id'            => 'footer-1',
		'description'   => esc_html__( 'Add widgets here.', 'revenue-pro' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 2', 'revenue-pro' ),
		'id'            => 'footer-2',
		'description'   => esc_html__( 'Add widgets here.', 'revenue-pro' ),
		'before_widget' => '<div id="%1$s" class="widget footer-widget %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 3', 'revenue-pro' ),
		'id'            => 'footer-3',
		'description'   => esc_html__( 'Add widgets here.', 'revenue-pro' ),
		'before_widget' => '<div id="%1$s" class="widget footer-widget %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 4', 'revenue-pro' ),
		'id'            => 'footer-4',
		'description'   => esc_html__( 'Add widgets here.', 'revenue-pro' ),
		'before_widget' => '<div id="%1$s" class="widget footer-widget %2$s">',
		'after_widget'  => '</div>',
...
add_action( 'widgets_init', 'revenue_pro_sidebar_init' );
...
function revenue_pro_scripts() {
    ...
    // Enqueues CSS styles
    wp_enqueue_style( 'revenue_pro-style', get_stylesheet_uri(), array(), '20180523' );     
