 ...
 * @since      1.0.0
 */
class revenue_pro_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			...
			'description' => __( 'Display random posts with thumbnails.', 'revenue-pro' )
		);

		// Create the widget.
		parent::__construct(
			'revenue_pro-random',                                   // $this->id_base
			__( '&raquo; Random Posts', 'revenue-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'revenue-pro' ),
			'limit'     => 5,
			'show_date' => true
		);
