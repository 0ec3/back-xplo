...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'revenue-pro' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'revenue-pro' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'revenue-pro' ),
		'cyrillic'     => __( 'Cyrillic', 'revenue-pro' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'revenue-pro' ),
		'devanagari'   => __( 'Devanagari', 'revenue-pro' ),
		'greek'        => __( 'Greek', 'revenue-pro' ),
		'greek-ext'    => __( 'Greek Extended', 'revenue-pro' ),
		'khmer'        => __( 'Khmer', 'revenue-pro' ),
		'latin'        => __( 'Latin', 'revenue-pro' ),
		'latin-ext'    => __( 'Latin Extended', 'revenue-pro' ),
		'vietnamese'   => __( 'Vietnamese', 'revenue-pro' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'revenue-pro' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'revenue-pro' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'revenue-pro' ),
