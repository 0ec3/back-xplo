...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'revenueplus' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'revenueplus' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'revenueplus' ),
		'cyrillic'     => __( 'Cyrillic', 'revenueplus' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'revenueplus' ),
		'devanagari'   => __( 'Devanagari', 'revenueplus' ),
		'greek'        => __( 'Greek', 'revenueplus' ),
		'greek-ext'    => __( 'Greek Extended', 'revenueplus' ),
		'khmer'        => __( 'Khmer', 'revenueplus' ),
		'latin'        => __( 'Latin', 'revenueplus' ),
		'latin-ext'    => __( 'Latin Extended', 'revenueplus' ),
		'vietnamese'   => __( 'Vietnamese', 'revenueplus' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'revenueplus' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'revenueplus' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'revenueplus' ),
