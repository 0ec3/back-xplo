...
function customizer_library_demo_options() {
	...
	$sections[] = array(
		'id' => $section,
		'title' => __( 'Theme Settings', 'revenue-pro' ),
		'priority' => '10'
	);

	$options['logo'] = array(
		'id' => 'logo',
		'label'   => __( 'Logo', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'image',
	...
	$options['primary-color'] = array(
		'id' => 'primary-color',
		'label'   => __( 'Theme Primary Color', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'color',
	...
	$options['secondary-color'] = array(
		'id' => 'secondary-color',
		'label'   => __( 'Theme Secondary Color', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'color',
	...
	$options['primary-font'] = array(
		'id' => 'primary-font',
		'label'   => __( 'Body Font', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'select',
	...
	$options['secondary-font'] = array(
		'id' => 'secondary-font',
		'label'   => __( 'Heading Font', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'select',
		'choices' => customizer_library_get_font_choices(),
		'default' => 'Roboto'
	...
	$options['site-layout'] = array(
		'id' => 'site-layout',
		'label'   => __( 'Site Layout', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'radio',
	...
	$options['sticky-nav-on'] = array(
		'id' => 'sticky-nav-on',
		'label'   => __( 'Sticky header navigation', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => false,
	);			
	...
	$options['header-search-on'] = array(
		'id' => 'header-search-on',
		'label'   => __( 'Display header search form', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 1,
	);	
	...
	$options['featured-content-on'] = array(
		...
		'label'   => __( 'Display featured content on homepage', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 1,
	);
	...
	$options['featured-num'] = array(
		'id' => 'featured-num',
		'label'   => __( 'Number of featured posts to show', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'text',
		'default' => '4',		
	);
	...
	$options['loop-style'] = array(
		'id' => 'loop-style',
		'label'   => __( 'Latest Posts Style', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'select',
	...
	$options['entry-excerpt-length'] = array(
		...
		'label'   => __( 'Number of words to show on excerpt', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'text',
		'default' => '30',		
	);
	...
	$options['single-breadcrumbs-on'] = array(
		...
		'label'   => __( 'Display breadcrumbs on single posts', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => true,
	);	
	...
	$options['single-share-on'] = array(
		'id' => 'single-share-on',
		'label'   => __( 'Display share icons on single posts', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 1,
	);	
	...
	$options['single-featured-on'] = array(
		...
		'label'   => __( 'Display featured image on single posts', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => true,
	);	
	...
	$options['author-box-on'] = array(
		'id' => 'author-box-on',
		'label'   => __( 'Display author box on single posts', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 1,
	);	
	$options['related-posts-on'] = array(
		'id' => 'related-posts-on',
		'label'   => __( 'Display related posts on single posts', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 1,
	);	
	...
	$options['footer-widgets-on'] = array(
		...
		'label'   => __( 'Display footer widgets', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 1,
	);
	...
	$options['back-top-on'] = array(
		'id' => 'back-top-on',
		'label'   => __( 'Display "back to top" icon link on the site bottom', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 1,
	);	
	...
	$options['footer-credit'] = array(
		'id' => 'footer-credit',
		'label'   => __( 'Customize Site Footer Text/Link', 'revenue-pro' ),
		'section' => $section,
		'type'    => 'textarea',
	...
	//	'id' => 'example-range',
	//	'label'   => __( 'Example Range Input', 'revenue-pro' ),
	//	'section' => $section,
	//	'type'    => 'range',
	//	'input_attrs' => array(
	//      'min'   => 0,
