			...
			<div class="site-info">
				...
				<?php if(get_theme_mod('footer-credit')) { 
					...
					echo get_theme_mod('footer-credit');
						...
						$theme_uri = 'https://www.freshthemes.com/themes/';
						$author_uri = 'https://www.freshthemes.com/';
				?>

				&copy; <?php echo date("o"); ?> <a href="<?php echo home_url(); ?>"><?php echo get_bloginfo('name'); ?></a> - <?php echo __('Theme by', 'revenueplus'); ?> <a href="<?php echo $author_uri; ?>" target="_blank">FreshThemes</a>
...
<?php if ( get_theme_mod('back-top-on', true) ) : ?>
	...
	<div id="back-top">
		<a href="#top" title="<?php echo __('Back to top', 'revenueplus'); ?>"><span class="genericon genericon-collapse"></span></a>
	</div>
