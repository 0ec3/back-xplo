...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="breadcrumbs">
		<span class="breadcrumbs-nav">
			<a href="<?php echo home_url(); ?>"><?php esc_html_e('Home', 'revenue-pro'); ?></a>
			<span class="post-category"><?php revenue_pro_first_category(); ?></span>
	...
	<div class="entry-content">
		...
		<?php
			the_content( sprintf(
				...
				wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'revenue-pro' ), array( 'span' => array( 'class' => array() ) ) ),
				the_title( '<span class="screen-reader-text">"', '"</span>', false )
			) );

			wp_link_pages( array(
				'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'revenue-pro' ),
				'after'  => '</div>',
			) );
		?>
	</div><!-- .entry-content -->
...
<?php
	...
	if ( $related->have_posts() ) : $i = 1; ?>
		...
		<div class="entry-related clear">
			<h3><?php esc_html_e('You May Also Like', 'revenue-pro'); ?></h3>
...
<div class="author-box clear">
	...
	<div class="author-meta">	
		<h4 class="author-name"><?php echo __('About the Author:', 'revenue-pro'); ?> <span><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) ); ?>"><?php the_author_meta('display_name'); ?></a></span></h4>	
