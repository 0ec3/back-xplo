 ...
 * @since      1.0.0
 */
class revenue_pro_Social_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-revenue_pro-social widget_social_icons',
			'description' => __( 'Display your social media icons.', 'revenue-pro' )
		);

		// Create the widget.
		parent::__construct(
			'revenue_pro-social',                        // $this->id_base
			__( '&raquo; Social Icons', 'revenue-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Follow Us', 'revenue-pro' ),
			'desc'       => esc_html__( 'Stay updated via social channels', 'revenue-pro' ),		
			'facebook'   => '',
			'twitter'    => '',
			'gplus'      => '',
			'pinterest'  => '',
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'desc' ); ?>">
				<?php _e( 'Description', 'revenue-pro' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'gplus' ); ?>">
				<?php _e( 'Google Plus', 'revenue-pro' ); ?>
			</label>
