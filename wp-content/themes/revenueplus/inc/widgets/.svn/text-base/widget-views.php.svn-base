 ...
 * @since      1.0.0
 */
class revenue_pro_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-revenue_pro-views widget_posts_thumbnail',
			'description' => __( 'Display the most viewed posts with thumbnails.', 'revenue-pro' )
		);

		// Create the widget.
		parent::__construct(
			'revenue_pro-views',                                        // $this->id_base
			__( '&raquo; Most Viewed Posts', 'revenue-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Most Viewed Posts', 'revenue-pro' ),
			'limit'     => 5,
			'show_date' => true
		);
