 ...
 * @since      1.0.0
 */
class revenueplus_Ad_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			...
			'description' => esc_html__( 'Display any kinds of advertisements.', 'revenueplus' ),
			'customize_selective_refresh' => true
		);

		// Create the widget.
		parent::__construct(
			'freshthemes-ad',                                    // $this->id_base
			esc_html__( '&raquo; Advertisement', 'revenueplus' ), // $this->name
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad_code' ); ?>">
				<?php esc_html_e( 'Ad Code', 'revenueplus' ); ?>
			</label>
