 ...
 * @since      1.0.0
 */
class revenueplus_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-revenueplus-views widget_posts_thumbnail',
			'description' => __( 'Display the most viewed posts with thumbnails.', 'revenueplus' )
		);

		// Create the widget.
		parent::__construct(
			'revenueplus-views',                                        // $this->id_base
			__( '&raquo; Most Viewed Posts', 'revenueplus' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Most Viewed Posts', 'revenueplus' ),
			'limit'     => 5,
			'show_date' => true
		);
