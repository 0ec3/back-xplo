 ...
 * @package    revenueplus
 * @author     FreshThemes
 * @copyright  Copyright (c) 2020, FreshThemes
 * @license    http://www.gnu.org/licenses/gpl-2.0.html
 * @since      1.0.0
 */
class revenueplus_Newsletter_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			...
			'description' => esc_html__( 'Display newsletter subscribe form.', 'revenueplus' ),
			'customize_selective_refresh' => true
		);

		// Create the widget.
		parent::__construct(
			'revenueplus-newsletter',                                    // $this->id_base
			esc_html__( '&raquo; Newsletter', 'revenueplus' ), // $this->name
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>">
				<?php esc_html_e( 'Title', 'revenueplus' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'form_code' ); ?>">
				<?php esc_html_e( 'Subscribe Form Code', 'revenueplus' ); ?> <span style="display: block;color: #999;">See <a href="https://demo.freshthemes.com/revenueplus/wp-content/themes/revenueplus/form-example.txt" target="_blank">example code</a>.</span>
			</label>
