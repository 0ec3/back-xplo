 ...
 * @since      1.0.0
 */
class revenueplus_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-revenueplus-random widget_posts_thumbnail',
			'description' => __( 'Display random posts with thumbnails.', 'revenueplus' )
		);

		// Create the widget.
		parent::__construct(
			'revenueplus-random',                                   // $this->id_base
			__( '&raquo; Random Posts', 'revenueplus' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'revenueplus' ),
			'limit'     => 5,
			'show_date' => true
		);
